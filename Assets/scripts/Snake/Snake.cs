...
namespace Snake2D
{
    public class Snake : MonoBehaviour
    {
        ...
        {
            var body = new SnakeBodyPart(this);
        ...
        private class SnakeBodyPart
        {
            ...
            public SnakeBodyPart(Snake parentSnake)
            {
                snakeBody = Instantiate(parentSnake.snakeBodyPrefab, new Vector3(-1, -1, 0), Quaternion.identity);
                spriteRenderer = snakeBody.GetComponent<SpriteRenderer>();
                transform = snakeBody.transform;

                var snakebody = snakeBody.GetComponent<SnakeBody>();
